...
<!--Section header -->
	<section class="header">
		...
		<a href="formationsView.php" class="btn">Nos formations</a>
	</section>
...
<!-- ---------------Section A propos ------------------>
	<section class="apropos">
		<div>
			...
			<a href="formationsView.php" class="btn">En savoir Plus</a>
...
<!-- -----------Section devenir formateur --------------->
	<section class="devenir-formateur">
		<div class="text-bloc">
			...
			<a href="formationsView.php"><button class="btn-formateur">Devenir Formateur</button></a>
